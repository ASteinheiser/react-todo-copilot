...
To get started, you can either follow the `Project Setup` section below, or:
...
And with that, you're good to go! Check out the `The Experiment` section for next steps...
...
# Project Setup
You can follow the instructions below if you want to setup the base project yourself, instead of using the `base-template` branch:
